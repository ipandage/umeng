...
import net.tatabang.push.ios.IOSCustomizedcast;
import net.tatabang.push.ios.IOSFilecast;
import net.tatabang.push.ios.IOSGroupcast;
...
public class Demo {
	...
	public void sendAndroidBroadcast() throws Exception {
		...
		broadcast.setTicker( "程序测试Broadcast 2");
		broadcast.setTitle(  "程序测试Broadcast title");
		broadcast.setText(   "程序测试Broadcast text");
	...
	public void sendAndroidUnicast() throws Exception {
		...
		unicast.setDeviceToken( "12341234123412341234123412341234123412341234");
		unicast.setTicker( "程序发送");
		unicast.setTitle(  "程序发送");
		unicast.setText(   "程序发送");
